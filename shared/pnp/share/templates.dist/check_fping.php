...
# $Id: check_fping.php 571 2008-12-03 12:26:07Z pitchfork $
#
# RTA
#
$ds_name[1] = "Round Trip Times";
$opt[1] = "--vertical-label \"RTA\"  --title \"Ping times for  $hostname /
$servicedesc\" ";
...
$opt[2] = "--vertical-label \"Packets lost\" -l0 -u105 --title \"Packets
lost for  $hostname / $servicedesc\" ";
