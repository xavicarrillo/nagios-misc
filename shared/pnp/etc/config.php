...
## Version: $Id: config.php.in 607 2009-03-12 18:39:20Z pitchfork $
## License: GPL
...
#
$conf['rrdbase'] = "/etc/nagios/shared/pnp/share/perfdata/";
#
# Page Config Location
#
$conf['page_dir'] = "/etc/nagios/shared/pnp/etc/pages/";
#
...
#
$conf['background_pdf'] = '/etc/nagios/shared/pnp/etc/background.pdf' ;
#
# Enable JSCalendar
#
$conf['use_calendar'] = 1;
